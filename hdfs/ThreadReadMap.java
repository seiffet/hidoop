...
public class ThreadReadMap implements Runnable {
	...
	public ThreadReadMap(Format fichierdestination, String nomfichier, String formatfichiertype, HashMap<Integer,ArrayList<String>> repartitionfichier) {
	...
	public void run() {
		...
		for (int bloc : repartitionfichier.keySet()) {
			...
			pw.println("RDM" + "//" + nomfichier + "//" + formatfichiertype + "//" + Integer.toString(bloc));
